  ...
  return `
    ...
    <script>
      ...
      function sendBccChatMessage() {
        ...
        userDiv.style.cssText = 'background:${widget.brandColor || "#3b82f6"} !important; color:#ffffff !important; padding:10px 14px !important; border-radius:12px !important; max-width:85% !important; align-self:flex-end !important; line-height:1.4 !important; font-family:"Inter",sans-serif !important; box-sizing:border-box !important; text-align:left !important;';
