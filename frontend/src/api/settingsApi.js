...
export const useGetDMTeamSettingsQuery = createQueryHook(() => '/settings/dm-team');
export const useGetDepartmentsQuery = createQueryHook(() => '/departments');
export const useGetPriorityLevelsQuery = createQueryHook(() => '/settings/priority-levels');
export const useUpdateDMTeamSettingsMutation = createMutationHook((data) => ({ url: '/settings/dm-team', method: 'PUT', body: data }));
