...
performanceScorecardSchema.pre("save", async function () {
  if (this.performanceCategories && this.isModified("performanceCategories")) {
    const categoryKeys = Object.keys(this.performanceCategories.toObject ? this.performanceCategories.toObject() : this.performanceCategories);
    categoryKeys.forEach((key) => {
      ...
      if (category && typeof category === "object") {
        ...
        if (
          ...
          this.performanceCategories[key].oh = undefined;
        }
        if (
          category.hr === null ||
          ...
          this.performanceCategories[key].hr = undefined;
        }
        if (
          category.self === null ||
          ...
          this.performanceCategories[key].self = undefined;
        }
      }
    });
  }
