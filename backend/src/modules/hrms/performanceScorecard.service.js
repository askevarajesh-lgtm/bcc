const PerformanceScorecard = require("./models/performanceScorecard.model");
...
const submitSelfAssessment = async (selfAssessmentData, companyId, userId) => {
  const month = Number(selfAssessmentData.month);
  const year = Number(selfAssessmentData.year);
