...
const OptimizationSnapshotSchema = new mongoose.Schema({
  ...
  seo: {
    ...
    siteHealthDetails: {
      ...
      redirected: { type: Number, default: null },
      blocked: { type: Number, default: null },
      haveIssues: { type: Number, default: null },
      errors: [{ type: mongoose.Schema.Types.Mixed }],
      warnings: [{ type: mongoose.Schema.Types.Mixed }],
      notices: [{ type: mongoose.Schema.Types.Mixed }],
      statusCodeGroups: { type: mongoose.Schema.Types.Mixed, default: {} },
      sitemapStats: { type: mongoose.Schema.Types.Mixed, default: {} },
      crawlDepthStats: { type: mongoose.Schema.Types.Mixed, default: {} },
      topIssues: [{ type: Number }],
      topInsights: [{ type: Number }],
      blockedPageStats: { type: mongoose.Schema.Types.Mixed, default: {} },
      fetchedAt: { type: Date, default: null },
      source: { type: String, default: 'Semrush' }
    },
